...
void DisplayStudentInformation(const vector<Data>& c) {
	...
	if (c.empty())
		...
		cout << setw(10) << left << "学号" << setw(10) << left << "班级" << setw(10) << left << "姓名" << setw(5) << left << "性别" << setw(15) << left << "专业"
			<< setw(10) << left << "数学成绩" << setw(10) << left << "英语成绩" << setw(10) << left << "体育成绩" << setw(10) << left << "平均分" << endl;
